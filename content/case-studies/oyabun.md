...
- **Search intent:** Commercial. Utilisateurs cherchant un studio capable de concevoir des applications gaming, Web3 ou Telegram.
- **Primary keyword:** design application Web3
- **Secondary keywords:** UX UI gaming, design NFT, application Telegram, product design Web3
- **Title tag:** Oyabun - Application Gaming & Web3 | P-XEL Studio
- **Meta description:** Conception et design d'une application gaming Web3 avec integration Telegram. Direction artistique, product design et systeme de jeu complet. Etude de cas P-XEL Studio.
...
Product Design / Gaming / Web3 / Telegram

**One-liner (Satoshi):**
Application gaming Web3 avec economie de tokens, systeme de clans et integration Telegram. Un univers complet conçu pour engager et retenir.

**Key Result (JetBrains Mono, accent, large):**
Un produit gaming complet, du concept au lancement
...
**H2:**
Un produit gaming a la croisee du Web3 et du mobile.
...
**H2:**
Penser en systeme, pas en ecrans.

On a commence par la boucle de jeu, pas par l'interface. Qu'est-ce qui fait revenir un joueur ? Quelle est la progression ? Quels sont les paliers de recompense ? Comment le systeme de clans cree de la retention sociale ? Ces questions de game design ont conditionne chaque decision d'interface. L'economie de tokens a ete conçue comme un systeme ferme avec des entrees et des sorties equilibrees. Les joueurs gagnent des tokens par l'activite in-game, les depensent pour progresser, et le systeme reste stable sans inflation. On a cartographie l'ensemble avant de dessiner le premier ecran. La direction artistique a ete traitee comme un pilier de produit, pas comme une couche decorative. L'univers visuel devait porter l'immersion autant que les mecaniques de jeu.
...
**H2:**
Un univers visuel qui porte le produit.

La direction artistique s'inspire de l'esthetique neo-japonaise : contrastes marques, typographie forte, palette sombre avec des accents vifs. Chaque element visuel sert le worldbuilding. Les avatars, les badges de clan, les ecrans de progression, les animations de recompense : tout participe a un univers coherent qui donne au joueur l'impression d'etre dans un produit construit, pas dans un prototype.

L'interface a ete conçue pour fonctionner dans les contraintes de Telegram Mini Apps. Navigation simplifiee, hierarchie visuelle claire, actions principales accessibles en un tap. Le joueur ne lit pas un mode d'emploi. Il ouvre l'app, comprend la mecanique, et joue.
...
**H2:**
Un produit gaming pret a deployer. Pas un concept.

Oyabun est un produit complet avec un univers visuel construit, des mecaniques de jeu specifiees, une economie de tokens equilibree et une experience utilisateur conçue pour Telegram. Le projet demontre la capacite de P-XEL a travailler sur des produits complexes qui depassent le cadre classique du web : game design, worldbuilding, systemes economiques, distribution sur des canaux non-conventionnels. C'est du product design applique a un domaine ou la plupart des studios de design ne vont pas.
...
Figma · Telegram Mini Apps · Web3 · Token Economy Design
...
**Projet suivant:**
[Arduenna Gin](/work/arduenna-gin/) ->

**CTA Block:**

**H3:**
Un produit digital ambitieux a concevoir ?

**Body:**
On conçoit des [applications web et produits digitaux](/services/application-web-mvp/) qui sortent du cadre. Direction artistique, product design, systemes complexes.
...
- /services/application-web-mvp/ (application, product design mentions)
- /contact/ (CTA)
- /work/arduenna-gin/ (next project)

## Images

- oyabun-hero.webp (hero - game interface or key visual)
- oyabun-clans.webp (clan hierarchy system)
- oyabun-ui.webp (in-game interface screens)
