...
function Logo() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect className={`${styles.logoAccent} ${styles.px1}`} x="56.87" y="107.19" width="42.06" height="42.06" />
      <rect className={`${styles.logoAccent} ${styles.px2}`} x="98.93" y="46.14" width="42.06" height="42.06" />
      <rect className={`${styles.logoFill} ${styles.px3}`} x="351.99" y="80.18" width="42.06" height="42.06" />
      <rect className={`${styles.logoAccent} ${styles.px4}`} y="65.12" width="42.06" height="42.06" />
      ...
      <g>
        <rect className={`${styles.logoAccent} ${styles.px5}`} x="165.92" y="170.28" width="42.06" height="42.06" />
