...
import { getBruxellesCityService } from "@/lib/content/cities/bruxelles-services";
...
export async function generateMetadata({
  ...
  const cityContent = getBruxellesCityService(
...
export default async function BruxellesServicePage({
  params,
}: {
  params: Promise<{ locale: string; service: string }>;
}) {
