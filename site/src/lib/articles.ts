...
export const articles: ArticleMeta[] = [
  ...
  },
  {
    ...
    excerpt: { fr: "Conditions, montants, démarches : tout savoir sur les chèques-entreprises pour financer votre projet digital en Wallonie.", en: "Eligibility, amounts, process: everything you need to know about business vouchers to fund your digital project in Wallonia." },
    readingTime: "8 min",
    image: "/legacy-assets/images/Articles-Digitalisation.webp",
    dateISO: "2026-03-27",
    relatedServices: ["creation-site-web", "application-web-mvp"],
    relatedArticles: ["aides-digitalisation-belgique", "combien-coute-un-site-web", "combien-coute-application-web"],
  },
  {
    ...
    readingTime: "10 min",
    image: "/images/perspectives/agences-web-belgique.webp",
    dateISO: "2026-03-27",
  ...
  },
  {
    ...
    category: { fr: "Produit", en: "Product" },
    title: { fr: "SaaS en Belgique : comment lancer votre plateforme", en: "SaaS in Belgium: how to launch your platform" },
    excerpt: { fr: "Guide pratique pour créer un SaaS en Belgique. Validation, MVP, stack technique, budget, aides et erreurs à éviter.", en: "Practical guide to launching a SaaS in Belgium. Validation, MVP, tech stack, budget, grants and mistakes to avoid." },
    readingTime: "11 min",
    image: "/images/perspectives/lancer-saas-belgique.webp",
    dateISO: "2026-03-27",
    relatedServices: ["application-web-mvp", "ai-studio"],
  ...
  },
  {
    ...
    category: { fr: "Technologie", en: "Technology" },
    title: { fr: "Next.js vs WordPress : quel choix pour votre site en 2026 ?", en: "Next.js vs WordPress: which one to choose for your website in 2026?" },
    excerpt: { fr: "Performance, SEO, sécurité, coûts, maintenance. Comparaison complète pour choisir la bonne technologie selon votre projet.", en: "Performance, SEO, security, costs, maintenance. Full comparison to choose the right technology for your project." },
    readingTime: "10 min",
    image: "/images/perspectives/nextjs-vs-wordpress.webp",
    dateISO: "2026-03-27",
    relatedServices: ["creation-site-web", "refonte-site-web"],
    relatedArticles: ["no-code-vs-code", "combien-coute-un-site-web", "refonte-site-web"],
  },
];
