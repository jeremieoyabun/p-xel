  ...
  fr: {
    ...
    bruxellesFaq: [
      ...
      },
      {
        ...
        answer:
          "Landing page : 1 semaine. Site vitrine : 2 à 4 semaines. Application web : 4 à 8 semaines. On définit un calendrier précis dès le départ et on le respecte. Pas de dérives.",
      },
      {
        question:
  ...
  en: {
    ...
    bruxellesFaq: [
      ...
      },
      {
        ...
        answer:
          "Landing page: 1 week. Corporate site: 2 to 4 weeks. Web application: 4 to 8 weeks. We define a precise schedule from the start and we stick to it. No drift.",
      },
      {
        question:
